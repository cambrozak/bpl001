#Session One: Introductions, Orientation, Robots Declassified, First Program
...
_**Activity:** Students get acquainted with the IDE by loading the LCD library and editing the robot name program_<br>
